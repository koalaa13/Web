...
import ru.itmo.wp.model.repository.impls.UserRepositoryImpl;
...
public class UserService {
    ...
    public void validateRegistration(User user, String password, String passwordConfirmation) throws ValidationException {
        ...
        if (user.getEmail().length() > 100) {
            throw new ValidationException("Email is too large");
        }
        ...
        if (!Objects.equals(password, passwordConfirmation)) {
            throw new ValidationException("Passwords aren't equal");
        }
    }
    ...
    public User validateAndFindByLoginOrEmailAndPassword(String loginOrEmail, String password) throws ValidationException {
        ...
        User user = userRepository.findByLoginOrEmailAndPasswordSha(loginOrEmail, passwordSha);
        if (user == null) {
