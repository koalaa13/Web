...
<template>
    <header>
        <a href="#page=Index" @click="changePage('Index')"><img src="../assets/img/logo.png" alt="Codeforces" title="Codeforces"/></a>
        <div class="languages">
        ...
        <nav>
            <ul>
                ...
                <li v-if="user"><a href="#page=AddPost" @click="changePage('AddPost')">Write Post</a></li>
            </ul>
        </nav>
    </header>
</template>
